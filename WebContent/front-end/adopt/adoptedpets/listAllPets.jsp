...
<header>
	<nav class="navbar navbar-expand-lg navbar-light ">
		<a href="<%=request.getContextPath()%>/front-end/adopt/frontEndIndex/index.jsp" class="navbar-brand ml-3">
			Cute:)
		...
		<div class="collapse navbar-collapse" id="navbarMenu">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item dropdown">
					<a href="<%=request.getContextPath()%>/front-end/adopt/hospital/appt/select_page3.jsp" class="nav-link">門診專區</a>
				</li>
				<li class="nav-item dropdown">
					<a href="<%=request.getContextPath()%>/front-end/adopt/Hotel/myIndex.jsp" class="nav-link">寵物旅館</a>
				</li>
				<li class="nav-item dropdown">
					<a href="#" class="nav-link">寵物商城</a>
				</li>
				<li class="nav-item dropdown">
					<a href="<%=request.getContextPath()%>/front-end/adopt/adopt/adoptedpets/listAllPets.jsp" class="nav-link">領養專區</a>
				</li>
			</ul>
